    ...
    <div className="navbar bg-red-50 p-3 ">
      <div className="navbar-start">
        ...
        <div className="flex items-center">
          <h1 className="text-2xl font-bold text-[#32CC32] ml-4">Exotic Escapes</h1>
        </div>
      </div>
      ...
      <div className="navbar-center hidden lg:flex">
        <ul className="menu menu-horizontal px-1">
          ...
          <li><NavLink className="font-bold" to="/TouristsSpotForm">All Tourist Spots</NavLink></li>
          {user && <li><NavLink className="font-bold" to="/AllAdededSpot">Add Tourist Spot</NavLink></li>}
